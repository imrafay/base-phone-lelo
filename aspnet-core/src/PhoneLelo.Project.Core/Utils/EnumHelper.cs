...
namespace PhoneLelo.Project.Utils
{
    public static class EnumHelper
    {
        ...
        public static List<int> GetValues(this Type enumType, bool excludeNone = false)
        {
            int noneValue = -1;
        ...
        public static bool IsDefined<T>(this string strEnumText)
        {
        ...
        public static bool IsDefined<T>(this int iEnumValue)
        {
        ...
        /// throws exception.
        /// </summary>
        public static T Parse<T>(this int iEnumValue)
        {
        ...
        /// throws exception.
        /// </summary>
        public static T Parse<T>(this string strEnumText) where T : struct
        {
        ...
        public static bool TryParse(this Type enumType, string value, out object objectEnum)
        {
            objectEnum = null;
            try
            {
        ...
        public static bool TryParse<T>(this string text, out T enumValue) where T : struct
        {
            if (IsDefined<T>(text))
            {
