...
{
    public partial class CreateUserProfileReviewTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductStoreId = table.Column<long>(nullable: true),
                    Review = table.Column<string>(nullable: true),
                    Rating = table.Column<int>(nullable: false),
                    GuestEmailAddress = table.Column<string>(nullable: true),
                    GuestFirstName = table.Column<string>(nullable: true),
                    GuestLastName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProfileReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserProfileReviews_ProductStores_ProductStoreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfileReviews_ProductStoreId",
                table: "UserProfileReviews",
                column: "ProductStoreId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProfileReviews_ReviewerId",
                table: "UserProfileReviews",
                column: "ReviewerId");
