...
export class ProductAdvertServiceProxy {
     ...
     * @return Success
     */
    getProductAdverForEdit(id: number | undefined): Observable<ProductAdvertDetailViewDto> {
        let url_ = this.baseUrl + "/api/services/app/ProductAdvert/GetProductAdverForEdit?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetProductAdverForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetProductAdverForEdit(<any>response_);
                } catch (e) {
